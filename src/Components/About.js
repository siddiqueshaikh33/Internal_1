...
const About = () => {
  return (
    ...
    <h2>LEADERSHIP</h2>
    <ul>
        <li>Sharmil Desai, Chief Development Officer</li>
        <li>Ashishh Desai, VP of Sales</li>
        <li> Hoang Nguyen, VP of Customer Success</li>
        <li> Jeremy Kuo, Director of Marketing</li>
